...
def get_dataset_labels(true_path, pred_path, save=False):
    ...
    if save == True:
        ...
        df.to_csv('/content/metrics.tsv', sep='\t', index=False)
...
if __name__ == "__main__":
    ...
    doc_true = f"{os.getcwd()}/dataset/train/boxes_transcripts_labels"
    doc_pred = f"{os.getcwd()}/dataset/train/boxes_transcripts_labels"
